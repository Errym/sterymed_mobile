...
import '../features/batches/data/datasources/batch_remote_datasource.dart';
import '../features/batches/data/repositories/batch_repository.dart';
...
Future<void> registerFeatures(GetIt getIt) async {
  ...
  // Devices (for device list screen)
  ...
  getIt.registerLazySingleton<BatchRemoteDatasource>(
      () => BatchRemoteDatasource(getIt<DioClient>().dio));
  getIt.registerLazySingleton<BatchRepository>(() => BatchRepository(
